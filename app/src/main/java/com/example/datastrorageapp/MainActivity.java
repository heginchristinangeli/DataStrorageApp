package com.example.datastrorageapp;
...
public class MainActivity extends AppCompatActivity {
    ...
    public static final String PREPNAME="com.vokasi.datastrorageapp.PREP";
    ...
    private static boolean hasPermission(Context contexts, String... permissions){
    ...
    public void simpanFileSP(){
        String isiFile=editText.getText().toString();
        SharedPreferences sharedPreferences=getSharedPreferences(PREPNAME,MODE_PRIVATE);
